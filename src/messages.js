...
class GazeOnSurface { constructor() {
  ...
  this.on_surf = Boolean;
  this.base_data = [ String /* "gaze.3d.0|1" */, Number /* timestamp*/ ];
...
class Pupil { constructor() {
  ...
  this.sphere = Sphere;
  this.projected_sphere = Ellipse;
  this.model_confidence = Number;       // 0..1
  this.model_id = Number;
...
class Fixation { constructor() {
  ...
  this.base_data = [[ String /*gaze.3d.0|1.*/, Number /*seconds*/ ]];
  this.timestamp = Number;      // seconds
...
class Surface { constructor() {
  ...
  this.name = String;           // "<ID>"
  this.surf_to_img_trans = [[ Number ]];
  this.img_to_surf_trans = [[ Number ]];
  this.gaze_on_surfaces = [ GazeOnSurface ];
  this.fixations_on_surfaces = [ Fixation ];  // ? please check whether this is indeed a list fo fixations
  this.timestamp = Number;      // seconds
}}
...
class Frame { constructor() {
  this.topic = String;          // "frame.eye.0|1" | "frame.world"
  this.width = Number;          //      192        |     1280
  this.height = Number;         //      192        |     720
